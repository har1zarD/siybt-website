...
const SAMPLE = {
  registrations: [
    { id: "demo-1", createdAt: new Date(), clubName: "KK Bosna", city: "Sarajevo", country: "BiH", contact: "Office", email: "office@example.test", phone: "+387", categories: ["U14M", "U16M"], needsAccommodation: true, rooms: 4, nights: 4, notes: "Sample row — DATABASE_URL not set.", status: "pending", emailSent: false },
    { id: "demo-2", createdAt: new Date(Date.now() - 86_400_000), clubName: "ALBA Berlin Y", city: "Berlin", country: "DE", contact: "Office", email: "office@example.test", phone: "+49", categories: ["U18M"], needsAccommodation: true, rooms: 2, nights: 4, notes: null, status: "confirmed", emailSent: true },
  ],
  contact: [
